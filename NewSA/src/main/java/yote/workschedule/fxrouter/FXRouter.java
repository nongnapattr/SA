...
public final class FXRouter {
    ...
    public static void goTo(String routeLabel, Object dataI, Object dataII, Object dataIII, Object dataIV) throws IOException {
        RouteScene route = (RouteScene)routes.get(routeLabel);
        route.data = dataI;
        route.dataII = dataII;
        route.dataIII = dataIII;
        route.dataIV = dataIV;
        loadNewRoute(route);
    }
    ...
    public static Object getDataIII() {
        return currentRoute.dataIII;
    }

    public static Object getDataIV() {
        return currentRoute.dataIV;
    }
    private static class RouteScene {
        ...
        private Object dataIII;
        private Object dataIV;
